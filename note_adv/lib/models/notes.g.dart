...
void _noteSerialize(
  ...
  writer.writeString(offsets[1], object.subtext);
...
Note _noteDeserialize(
  ...
  object.id = id;
  object.subtext = reader.readStringOrNull(offsets[1]);
...
extension NoteQueryFilter on QueryBuilder<Note, Note, QFilterCondition> {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subtextIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subtextIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subtextEqualTo(
    String? value, {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subtextGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subtextLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subtextBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subtextStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subtextEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subtextContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subtextMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subtextIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'subtext',
        value: '',
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> subtextIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'subtext',
        value: '',
...
extension NoteQuerySortBy on QueryBuilder<Note, Note, QSortBy> {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> sortBySubtext() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'subtext', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> sortBySubtextDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'subtext', Sort.desc);
    });
  }
...
extension NoteQuerySortThenBy on QueryBuilder<Note, Note, QSortThenBy> {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> thenBySubtext() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'subtext', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> thenBySubtextDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'subtext', Sort.desc);
    });
  }
...
extension NoteQueryWhereDistinct on QueryBuilder<Note, Note, QDistinct> {
  ...
  QueryBuilder<Note, Note, QDistinct> distinctBySubtext(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'subtext', caseSensitive: caseSensitive);
    });
  }
...
extension NoteQueryProperty on QueryBuilder<Note, Note, QQueryProperty> {
  ...
  QueryBuilder<Note, String?, QQueryOperations> subtextProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'subtext');
    });
  }
